                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="order-summary">
                            ...
                            <p>Lưu ý: Đây là đơn hàng đặt cọc. Bạn không thanh toán toàn bộ ngay lúc này. Xe của bạn sẽ được
                                giữ chỗ và bạn sẽ nhận hướng dẫn thanh toán phần còn lại sau khi xem xe.</p>
                        </div>
                    </div>
                </div>
            </div>
